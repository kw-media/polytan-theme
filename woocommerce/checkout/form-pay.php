	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'polytan' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'polytan' ); ?></th>
			</tr>
		</thead>
		<tbody>
