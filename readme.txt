...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/polytan.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/polytan)

## About

I’m a huge fan of Underscores, Bootstrap, and Sass. Why not combine these into a solid WordPress Theme Framework?
That’s what Polytan is.
You can use it as starter theme and build your own theme on top of it. Or you use it as parent theme and create your own child theme for Polytan.

At the moment, Polytan is in a very early stage. But if you want, feel free to use it for your own WordPress theme!

# Polytan WordPress Theme Framework

Website: [http://polytan.com](http://polytan.com)

Child Theme Project: [https://github.com/holger1411/polytan-child](https://github.com/holger1411/polytan-child)

## License
Polytan WordPress Theme, Copyright 2013-2017 Holger Koenemann
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 1 "theme/theme_variables";  // <--------- Add your variables into this file. Also add variables to overwrite Bootstrap or Polytan variables here
                  - 2 "../src/bootstrap-sass/assets/stylesheets/bootstrap";  // <--------- All the Bootstrap stuff - Don´t edit this!
                  - 3 "polytan/polytan"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the polytan folder from GitHub or from polytan.com
